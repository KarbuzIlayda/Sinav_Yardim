...
public class YKSFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mevkullanici = kullanici.getUid();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_yks, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        postlar = view.findViewById(R.id.rv_ykshome);
    ...
    public void onStart() {
        ...
        if (adapter == null) {
            ...
            vtreferans = veritabani.getReference("YKS postlar");
